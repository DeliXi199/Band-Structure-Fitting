...
if __name__ == "__main__":
    ...
    highest_band = 12
    lowest_band = 5
    fermi_level_fit = 5.1446
    fermi_level_band = 5.1446

    # 读取 EIGENVAL 文件的数据
    filename = os.path.join(os.path.dirname(__file__), "..", "Data", "EIGENVAL_band_Bi")
    ...
    # Bi的标签
    high_symmetry_labels = ["F_1", r"\Gamma", "L", "T_1/T", r"\Gamma", "F_2"]
    ...
    plt.title(f"Band Structure (Bands {lowest_band}-{highest_band})", fontsize=16)
